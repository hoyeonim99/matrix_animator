...
public class InverseListener implements ActionListener {
    ...
    public InverseListener(LinAlg linalg, JTextField a, JTextField b, JTextField c,
                    JTextField d){
        this.linalg = linalg;
        this.a = a;
        this.b = b;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if (aValue * dValue - bValue * cValue != 0){
            linalg.invertNextMatrix(aValue, bValue, cValue, dValue);
